...
public class Orders {
    ...
    public void updateOrderDetails(OrderFinalizeRequestDto dto) {
        this.usedPoint = dto.getUsedPoint();
        this.paidAmount = dto.getPaidAmount();
        this.paymentMethod = dto.getPaymentMethod();
        this.shippingName = dto.getShippingName();
        this.shippingPhone = dto.getShippingPhone();
        this.shippingAddress = dto.getAddress();
        this.shippingAddressDetail = dto.getAddressDetail();
    ...
    public void updatePaymentCompletedAt(LocalDateTime now){
        this.paymentCompletedAt = now;
    }
