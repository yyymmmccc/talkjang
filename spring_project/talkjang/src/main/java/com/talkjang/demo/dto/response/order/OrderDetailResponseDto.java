...
public class OrderDetailResponseDto {
    ...
    public static OrderDetailResponseDto from(Orders orders){
        return OrderDetailResponseDto.builder()
                ...
                .buyerDeliveryAddress(orders.getUser().getAddress())
                .buyerDeliveryAddressDetail(orders.getUser().getAddressDetail())
                .buyerPoint(orders.getUser().getPoint())
                ...
                .productDeliveryFee(orders.getProduct().getDeliveryFee())
