...
public class KakaoPayService {
    ...
    public CommonResponseDto ready(OrderInfoRequestDto orderInfoRequestDto){
        ...
        KakaoPayReadyRequestDto kakaoPayReadyRequestDto =
                KakaoPayReadyRequestDto.builder()
                        ...
                        .partner_user_id(orderInfoRequestDto.getPartner_user_id())
                        ...
                        .approval_url("http://localhost:8080/api/kakao-pay/approve?orderId=" + orderInfoRequestDto.getPartner_order_id() + "&userId=" + orderInfoRequestDto.getPartner_user_id())
    ...
    public ResponseEntity approve(String pgToken, String orderId, String userId) {
        ...
        ordersService.updateUserPoint(userId, orders);
